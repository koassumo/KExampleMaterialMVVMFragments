    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(adapterOnlyOneItemData: NoteRv) {
            ...
            when (adapterOnlyOneItemData.imageName) {
                "rv_bottom_app_bar_1" -> iv_pic.setImageResource(R.drawable.rv_bottom_app_bar)
                "rv_bottom_app_bar_2" -> iv_pic.setImageResource(R.drawable.rv_bottom_app_bar)
                "rv_bottom_app_bar_3" -> iv_pic.setImageResource(R.drawable.rv_bottom_app_bar)
            }
