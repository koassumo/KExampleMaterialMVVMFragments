...
import com.example.kexamplematerialmvvmfragments.ui.fragments.ConstrainedLayoutFragment
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(adapterOnlyOneItemData: NoteRv) {
            ...
            when (adapterOnlyOneItemData.imageName) {
                "rv_constraint_layout_1" -> itemView.iv_pic.setImageResource(R.drawable.rv_constrained_layout)
                "rv_constraint_layout_2" -> itemView.iv_pic.setImageResource(R.drawable.rv_constrained_layout)
                "rv_constraint_layout_3" -> itemView.iv_pic.setImageResource(R.drawable.rv_constrained_layout)
            }
